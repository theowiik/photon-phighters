...
public static class SceneResourceWrapper
{
  public static string MapsFolder => "res://Scenes/Maps";
  public static string StartScreenPath => "res://Scenes/Screens/StartScreen.tscn";
